...
export const LATEST_APP_VERSION = 'v2.8.1';
export const DIRECT_APK_URL = 'https://github.com/SUBHOJITPAUL797/LKS-DIALER/releases/download/v2.8.1/app-release.apk';
