...
export const LATEST_APP_VERSION = 'v2.8.2';
export const DIRECT_APK_URL = 'https://github.com/SUBHOJITPAUL797/LKS-DIALER/releases/download/v2.8.2/app-release.apk';
