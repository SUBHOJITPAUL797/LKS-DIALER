...
export const LATEST_APP_VERSION = 'v2.7.9';
export const DIRECT_APK_URL = 'https://github.com/SUBHOJITPAUL797/LKS-DIALER/releases/download/v2.7.9/app-release.apk';
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' }}>
          <a
            href={DIRECT_APK_URL}
            download="LKS-DIALER-v2.7.9.apk"
            target="_blank"
